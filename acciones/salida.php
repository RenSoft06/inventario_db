...
if ($producto->stock < $cantidad) {
    header('Location: ../movimientos.php?error=Stock insuficiente. Stock actual: ' . $producto->stock . ', Intenta sacar: ' . $cantidad);
    exit;
}
...
try {
    ...
    header('Location: ../movimientos.php?mensaje=Salida registrada correctamente');
} catch (Exception $e) {
    header('Location: ../movimientos.php?error=Error al registrar salida: ' . $e->getMessage());
}
?>
